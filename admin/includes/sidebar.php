<nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="collapse  " href="index.php?dashboard" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li class="nav-label">CRUD</li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="far fa-images"></i><span class="hide-menu">Slider</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index.php?view_slider">View Slider</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">User</span></a>
                            <ul aria-expanded="false" class="collapse">
